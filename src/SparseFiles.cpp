...
*/
BOOL CSparseFiles::VolumeSupportsSparseFiles(LPCTSTR lpRootPathName)
{
	DWORD dwVolFlags;
...
* File name
*/
BOOL CSparseFiles::IsSparseFile(LPCTSTR lpFileName)
{
...
*/
BOOL CSparseFiles::GetSparseFileSize(LPCTSTR lpFileName)
{
...
*/
HANDLE CSparseFiles::CreateSparseFile(LPCTSTR lpFileName)
{
...
*/
void CSparseFiles::SetSparseRange(HANDLE hSparseFile, LONGLONG start, LONGLONG size)
{
...
* File name
*/
BOOL CSparseFiles::GetSparseRanges(LPCTSTR lpFileName)
{
	// Open the file for read
	HANDLE hFile = CreateFile(lpFileName, GENERIC_READ, 0, NULL, 
		OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
	...
	do
	{
		...
		{
			_tprintf_s(L"allocated range: [%I64u] [%I64u]\n", 
